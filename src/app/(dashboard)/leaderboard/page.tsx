...
export default function LeaderboardPage() {
  ...
  return (
    <div className="flex flex-col items-center p-4 md:p-6 space-y-8 bg-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 items-end w-full max-w-4xl">
        ...
        <div className="flex justify-center md:order-1">
          {topThree.length > 1 && (
            <Card className="relative w-full max-w-xs text-center p-4 border-2 border-slate-400 shadow-lg bg-card">
              ...
              <p className="text-sm text-muted-foreground">{topThree[1].role?.replace(/_/g, ' ')}</p>
        ...
        <div className="flex justify-center md:order-2">
          {topThree.length > 0 && (
            <Card className="relative w-full max-w-xs text-center p-6 border-4 border-yellow-400 shadow-xl bg-card scale-110">
              ...
              <p className="text-md text-muted-foreground">{topThree[0].role?.replace(/_/g, ' ')}</p>
        ...
        <div className="flex justify-center md:order-3">
          {topThree.length > 2 && (
            <Card className="relative w-full max-w-xs text-center p-4 border-2 border-orange-500 shadow-lg bg-card">
              ...
              <p className="text-sm text-muted-foreground">{topThree[2].role?.replace(/_/g, ' ')}</p>
            ...
            <table className="w-full">
              <tbody>
                {restOfBoard.map((user, index) => (
                  <tr key={user.uid} className={cn("border-b last:border-none", user.uid === userProfile?.uid && 'bg-primary/10')}>
