              ...
              {events.map(event => (
                <Card key={event.id}>
                  <div className="relative h-40 w-full">
                     <Image src={event.mainImage.src} alt={event.mainImage.alt} fill style={{objectFit: 'cover'}} className="rounded-t-lg" data-ai-hint={event.mainImage.dataAiHint || 'event banner'} />
                  </div>
                  <CardHeader>
