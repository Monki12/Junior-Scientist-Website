...
const eventImageMap: Record<string, { src: string; alt: string; dataAiHint: string }> = {
    ...
    'default-logo': { src: '/logos/jsologo.jpg', alt: 'Junior Scientist Event Banner', dataAiHint: 'event banner' },
    'logo-black': { src: '/logos/logo-black.png', alt: 'Junior Scientist Logo Black', dataAiHint: 'logo' },
    'logo-white': { src: '/logos/logo-white.png', alt: 'Junior Scientist Logo White', dataAiHint: 'logo' },
